        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Average Usage" text={data?.average_usage} />

                <FormListItem label="Peak Usage" text={data?.peak_usage} />

                <FormListItem label="Low Usage" text={data?.low_usage} />
