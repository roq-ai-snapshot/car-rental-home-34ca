  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Rental Home - Unleashing the Power of Carsharing. Manage Profiles, Book Vehicles, Track Usage, and Assess Performance All in One Central Place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Rental Home - Unleashing the Power of Carsharing. Manage Profiles, Book Vehicles, Track Usage, and Assess Performance All in One Central Place.`}
            </Text>
            <Box
