          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Payment Type" text={data?.payment_type} />
                ...
                <FormListItem label="Payment Confirmation Code" text={data?.payment_confirmation_code} />

                <FormListItem label="Payment Description" text={data?.payment_description} />

                <FormListItem label="Payment Receipt Url" text={data?.payment_receipt_url} />

                <FormListItem label="Payment Reference Number" text={data?.payment_reference_number} />
              </List>
            </FormWrapper>
          </>
        )}
